  ...
  class Extractor
    ...
    def call(env)
      ...
      if request.script_name && request.script_name =~ PATH_INFO_MATCH
        ...
        env["curio_arch.external_account_id"] = AccountSlug.decode($2)
      ...
      if env["curio_arch.external_account_id"]
        account = Account.find_by(external_account_id: env["curio_arch.external_account_id"])
