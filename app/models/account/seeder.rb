class Account::Seeder
  ...
  private
    def populate
      ...
      # Cards
      playground.cards.create! creator: creator, title: "Finally, watch this CurioArch orientation video", status: "published", description: <<~HTML
        <p>There’s a whole lot more you can do in CurioArch. In the video below, 37signals founder and CEO, Jason Fried, will walk you through the basics in just 17 minutes.</p>
        <action-text-attachment url="https://videos.37signals.com/fizzy/assets/videos/fizzyorientation-4k.mp4" caption="CurioArch orientation" content-type="video/mp4" filename="fizzyorientation-4k.mp4"></action-text-attachment>
      HTML
      ...
      playground.cards.create! creator: creator, title: "Then, open the CurioArch menu", status: "published", description: <<~HTML
        ...
        <action-text-attachment url="https://videos.37signals.com/fizzy/assets/images/open-menu.gif" alt="Demo of opening the main menu" caption="Open the CurioArch menu" content-type="image/*" filename="open-menu.gif" presentation="gallery"></action-text-attachment>
      HTML
