...
class Signup::AccountNameGeneratorTest < ActiveSupport::TestCase
  ...
  test "generate" do
    ...
    assert_equal "Newart's CurioArch", account_name, "The 1st account doesn't have 1st in the name"
    ...
    account_name = @generator.generate
    assert_equal "Newart's 2nd CurioArch", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 3rd CurioArch", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 4th CurioArch", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 5th CurioArch", account_name
  end

  test "generate continues from the previous highest index" do
    account = Account.create!(external_account_id: "12th", name: "Newart's 12th CurioArch")
    Current.without_account do
    ...
    account_name = @generator.generate
    assert_equal "Newart's 13th CurioArch", account_name
  end
end
